...
class ScrapeData:
   ...
   def EnterQueryWrite(self):
       ...
       while row < row_num:
           ...
           print fromDate[row], toDate[row], data1[row], data2[row]
           ...
           for xlcol in range(4):
               ...
               if xlcol==0:
                   writesheet.write(row+1,xlcol,fromDate[row])
               elif xlcol==1:
                   writesheet.write(row+1,xlcol,toDate[row])
               elif xlcol==2:
                   writesheet.write(row+1,xlcol,data1[row])
               else:
                   writesheet.write(row+1,xlcol,data2[row])
